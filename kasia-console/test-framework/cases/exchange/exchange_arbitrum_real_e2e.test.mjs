/**
 * Phase 2 β real e2e — exchange on Arbitrum agent-to-agent
 *
 * Per NWT spec 672758bb + Sub #1 commit ed6fb5e92 + verdict 9f5802ff.
 *
 * Prefund (Sub #3 待):
 *   - broker (Trader-B) arbitrum: ~0.5 USDT + ~0.0005 ETH gas
 *   - taker (Trader-A) arbitrum: ~0.1 USDT + ~0.0005 ETH gas
 *
 * Skip default: skip_in_cron + skip_in_batch (~$1.5 ARB gas).
 */
