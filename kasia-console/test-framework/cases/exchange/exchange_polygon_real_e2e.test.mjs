/**
 * Phase 2 β real e2e — exchange on Polygon agent-to-agent
 *
 * Per NWT spec 672758bb + Sub #1 commit ed6fb5e92 + verdict 9f5802ff.
 * dispatcher 5 EVM 解锁 (5/13 J2 Sub #1) — polygon 真链 transferUsdt 走 transferERC20.
 *
 * Prefund (Sub #3 待):
 *   - broker (Trader-B) polygon: ~0.5 USDT + ~0.05 MATIC gas
 *   - taker (Trader-A) polygon: ~0.1 USDT + ~0.05 MATIC gas
 *
 * Skip default: skip_in_cron + skip_in_batch (~$0.5 polygon gas).
 */
