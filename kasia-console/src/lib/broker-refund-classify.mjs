// broker-refund-classify.mjs — broker 退款重发守卫 (v0.2 候选转正, 2026-08-29; NWT GREEN)（J2 2026-08-29; NWT L2 审注 (a) 收口; T4#1 CONFIRMED 真险有先例 87.9 KAS）
// 消费方: broker-refund-dedup.js(isOfferAlreadyRefunded 包装) / broker-state-authority.js advanceToRefunded / _advanceToRefundedNoOffer / broker-cancel-refund.js:86 预筛 / broker-intake-watcher.js _scanExpiredBrokerOffers 预筛
//
