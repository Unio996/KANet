...
export const LANGS = {
  en: {
    ...
    mybets_status_win_pending: '🎉 Won — payout pending on-chain confirmation',
    ...
    ro_line_settled_noresult: '{q} · Settled',
    ro_when_hours: '{h}h left',
    ro_when_minutes: '{m} min left',
    ...
    ro_state_settled_noresult: 'Status: Settled',
  ...
  zh: {
    ...
    mybets_status_win_pending: '🎉 赢了 — 赔付金额链上确认中',
