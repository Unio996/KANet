...
CONSOLE_PORT=3300  # TN12 sandbox (Bettor r205 王炸, J1 .106 host, 防撞 mainnet 3100)
...
if [ -f "$ENV_FILE" ]; then
  while IFS='=' read -r k v; do
    ...
    case "$k" in
      ...
      # B2 v0.5 UAT pain point #2 — pool market deadline minimum override (testnet quick demos)
...
BRIDGE_PORT=9300  # TN12 sandbox 防撞 mainnet 9100 cc-bridge
echo ""
