...
3. 🔴 **下面只有【一个】块今天真能跑。** 其余全部标 `NOT_AVAILABLE`,并写明缺什么。**这不是排版,是当前状态。**
...
### 步骤 4 —— mock 走一遍 `Intent → Agreement → Value Event → Settlement → Claim/Exit`　⏳ 建设中
...
- 🔴【未做】步骤 1 我只在 `127.0.0.1` 跑过。**从另一台机器、以外部身份是否可达,我没测** —— 而那正是这份文档的目标读者所处的位置
- 🔴【未做】我没有让任何外部的人读过这份文档
