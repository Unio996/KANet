// indexer-coverage.mjs — L2 期 1 原语候选（J2 2026-08-29; 稿 70208425 §2.2; NWT 审注 (b): 期 1 coverage 须保守偏洞）
// 落地位置候选: kasia-console/src/lib/indexer-coverage.mjs；表 kaspa_tx_log_coverage (迁移 v199+, DATABASE.md 同步)。
//
