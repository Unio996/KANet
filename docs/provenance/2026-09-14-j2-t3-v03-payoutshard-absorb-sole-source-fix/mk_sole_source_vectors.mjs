...
function compileGeneric(sil, ctor, tag) {
  const ctorPath = `scratch/_t1v06_check/SSF_${tag}.ctor.json`;
  const outPath = `scratch/_t1v06_check/SSF_${tag}.compiled.json`;
...
fs.writeFileSync('scratch/_t1v06_check/PayoutShard.sole-source-fix.test.json', JSON.stringify({ tests }, null, 1));
