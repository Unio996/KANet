...
> 🔴 **v0.13 ① Shape-B 命名 sweep**：LOCKED_F 在 reveal 被消费**转成 O_AUTHORIZED 后继**（非反应方直接领 LOCKED_F）；refund 寿命论证换成锚**实际 reveal DAA**（`OpTxInputDaaScore(O_AUTHORIZED)`）非 baked cutoff。
