# P1「验不成 ≠ 可以退款」不变量落地 — 设计 v0.3

> **Status**: CURRENT · **DESIGN-ONLY,零代码改动,不构成授权边界** — 两轮 NWT 红队已过,v0.3 收 NWT 复核两条 + Bettor 19:00/19:07 裁定 + Owner 19:03 判准,**待 NWT 终审**。
>
...
### 10.6 v0.3 定稿口径(Bettor 19:07 四项裁定,取代 §6 开放项①②)
