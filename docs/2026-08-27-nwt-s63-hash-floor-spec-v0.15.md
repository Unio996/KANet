...
2. **新增「支配定理」小节**：F1–F9 + L1–L5 + 定理，每条带坐标（F3 `ghostdag.rs:97`/`protocol.rs:153`；F4 `ordering.rs:46-48`；F8 `math/src/lib.rs:83-97`；余同前）。
