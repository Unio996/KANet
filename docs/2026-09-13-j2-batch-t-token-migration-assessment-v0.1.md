...
> **Status**: DRAFT-FOR-REVIEW · **v0.2**（2026-09-13T10:5xZ `date -u` · T0 四问全部实证，见 §T0；§1 的"13 个 covenant 文件撞状态初值"估计**撤回**）· v0.1 骨架 10:3xZ · J2 · Bettor 派工 SendMessage 10:3xZ（T0 现在做，隔离/离线/零花费）· 交 NWT 审 → Bettor → 合约/市场改造 = 钱路 ⇒ Owner 批（D-017 §3）。
