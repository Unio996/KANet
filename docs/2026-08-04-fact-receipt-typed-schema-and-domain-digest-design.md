> **Status**: DRAFT v0.7 — J1 主笔 · v0.4 并入 Codex 第五轮三件 · J2 审 v0.4(2 处必改,v0.5 改完 + 我自查出同族两处)· NWT 红队 v0.5 打中「§2.5 判据有项无用例」v0.6 补齐(§6 新增 29-33)· **NWT 红队 v0.6 打中「用例 29 只挡全外人、挡不住混合构造」,本版拆 29a/29b 应答** · 待 NWT 复核 · **design-only,零实现授权**
